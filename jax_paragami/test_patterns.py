...
class TestBasicPatterns(unittest.TestCase):
    def test_simplex_jacobian(self):
        ...
        jac_ad = \
            jax.jacrev(
                paragami.simplex_patterns._unconstrain_simplex_matrix, allow_int = True)(simplex)
        ...
        jac_ad = jax.jacrev(
            paragami.simplex_patterns._constrain_simplex_matrix, allow_int = True)(simplex_free)
...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_pdmatrix_custom_autodiff(self):
        ...
        check_grads(
            paragami.psdmatrix_patterns._vectorize_ld_matrix,(x_mat,),
            modes=['rev'], order=3)
        check_grads(
            paragami.psdmatrix_patterns._unvectorize_ld_matrix,(x_vec,),
            modes=['rev'], order=3)
