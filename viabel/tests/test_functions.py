...
def get_test_pattern():
    ...
    pattern['array'] = numeric_array_patterns.NumericArrayPattern(
        (2, 3, 4), lb=-1, ub=20, default_validate=False)
    pattern['mat'] = psdmatrix_patterns.PSDSymmetricMatrixPattern(
        3, default_validate=False)
    pattern['simplex'] = simplex_patterns.SimplexArrayPattern(
        2, (3, ), default_validate=False)
    subdict = pattern_containers.PatternDict()
    subdict['array2'] = numeric_array_patterns.NumericArrayPattern(
