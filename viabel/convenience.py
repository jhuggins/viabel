...
def bbvi(dimension, n_iters=10000, n_samples=10, log_density=None, family=None, objective=None, fit=None,  **kwargs):
    ...
    **kwargs
    ...
    if family is None:
        if objective is not None:
            raise ValueError('objective can only be specified if family is too')
